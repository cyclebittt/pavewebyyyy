        ...
        <div className="bg-neutral-800 rounded-3xl px-5 py-8 md:p-14 flex flex-col gap-6">
          ...
          <div className="text-white flex flex-col gap-6 md:gap-12 max-w-4xl">
            <h1 className="font-medium text-3xl md:text-5xl">
              Content That Converts: How to Tell Stories Your Audience Can’t
              Ignore
            </h1>
      ...
      <div className="px-5 py-10">
        <div className="bg-neutral-100 rounded-3xl px-5 py-8 md:p-14 flex flex-col gap-10">
          <h2 className="text-lg md:text-2xl font-medium">
            Ever wonder why some content sticks with you while others feel like
            white noise? Here’s the secret: it’s not just about what you
            say—it’s how you say it. In today’s digital age, content isn’t just
            king—it’s the entire kingdom. It connects, captivates, and
            convinces.
          </h2>

          <div className="flex flex-col gap-4">
            <p className="text-neutral-600">
              At Pave, we believe that great content isn’t just a one-way
              conversation—it’s a shared experience that sparks engagement and
              builds relationships. Let’s dive into the art of content creation
              and how we can help you craft stories that truly resonate.
            </p>

            <h3 className="font-bold text-lg md:text-xl">
              What Is Content Creation Really About?
            </h3>
            <p className="text-neutral-600">
              Content Creation is where creativity meets strategy. It’s not just
              about filling up a blog post or a social feed—it’s about building
              connections. At Pave, we take this a step further. For us, Content
              Creation means crafting experiences:
            </p>
            ...
            <p className="text-neutral-600">
              Think of it as storytelling that’s designed to inform, entertain,
              and convert.
            </p>

            <h3 className="font-bold text-lg md:text-xl">
              The Secret Sauce: Creating with Purpose
            </h3>
            <p className="text-neutral-600">
              Here’s the thing: content without a purpose is like spaghetti
              without sauce—messy and unmemorable. Every piece of content we
              create is rooted in your brand’s identity and goals. Whether it’s
              a blog post, an Instagram story, or a product video, it’s all
              about telling your story in a way that hits home with your
              audience.
            </p>

            <h3 className="font-bold text-lg md:text-xl">
              The Elements of Exceptional Content
            </h3>
            <p className="text-neutral-600">
              Not all content is created equal. Here’s what we bring to the
              table:
            </p>
            <ul className="list-disc pl-5 text-neutral-600">
              <li>
                <strong>Text That Speaks Volumes:</strong> From witty taglines
                to in-depth articles, we write words that capture attention and
                build trust.
              </li>
              <li>
                <strong>Visuals That Pop:</strong> A picture might be worth a
                thousand words, but we make sure those words are impactful.
                Eye-catching graphics, sleek banners, and thumb-stopping social
                media posts are our specialty.
              </li>
              <li>
                <strong>Videos That Connect:</strong> Whether it’s a heartfelt
                brand story, a snappy tutorial, or a product showcase, we create
                videos your audience will want to share—and rewatch.
              </li>
            </ul>
            ...
            <p className="text-neutral-600">
              Here’s a fact: people buy from brands they trust. Great content
              builds that trust by showing your audience you understand their
              needs, challenges, and aspirations. It’s not just about filling up
              space—it’s about starting conversations and creating connections.
            </p>
            <p className="text-neutral-600">
              Done right, content is your brand’s superpower. It turns curious
              browsers into loyal customers and casual followers into your
              biggest advocates.
            </p>
            ...
            <ul className="list-disc pl-5 text-neutral-600">
              <li>
                <strong>Discovery:</strong> We dive deep into your brand—your
                mission, your audience, and your goals.
              </li>
              <li>
                <strong>Strategy & Planning:</strong> We map out a content plan
                tailored to your voice and objectives.
              </li>
              <li>
                <strong>Creation & Collaboration:</strong> Our team of writers,
                designers, and videographers bring your vision to life, with
                your feedback guiding every step.
              </li>
              <li>
                <strong>Distribution:</strong> We optimize and share your
                content across the platforms that matter most to your audience.
              </li>
            </ul>

            <p className="text-neutral-600">
              Content isn’t about shouting into the void—it’s about creating a
              dialogue. Every blog post, graphic, or video is an opportunity to
              connect with your audience, invite engagement, and build a
              community.
            </p>
            <p className="text-neutral-600">
              At Pave, we see content as more than just marketing—it’s the
              bridge between your brand and the people who believe in it.
            </p>

            <h3 className="font-bold text-lg md:text-xl">
              Ready to Create Stories That Matter?
            </h3>
            <p className="text-neutral-600">
              If you’re tired of content that falls flat, we’re here to help.
              Whether you need a full-blown content strategy or just a little
              boost for your next campaign, we’ve got your back.
            </p>
            <p className="text-neutral-600">
              Let’s craft stories that inspire, visuals that captivate, and
              videos that convert. Together, we’ll pave the way to your brand’s
              success.
            </p>
          </div>
