...
const INITIAL_PROJECT = {
  ...
  phases: [
    ...
    },
    {
      ...
      endDate: "2026-04-20",
      payment: { label: "Projektpreis", amount: 250 },
      tasks: [
        { id: "t4", title: "Feedback-Meeting", status: "open", priority: "high" },
        { id: "t5", title: "Korrekturen einarbeiten", status: "open", priority: "high" },
        { id: "t6", title: "Domain verknüpfen bzw. Code übergeben", status: "open", priority: "high" },
      ],
    },
  ],

  milestones: [
    { id: "m1", label: "Design abgestimmt", date: "2026-04-17", done: false },
    { id: "m2", label: "Feedback eingearbeitet", date: "2026-04-19", done: false },
    { id: "m3", label: "Projekt übergeben", date: "2026-04-20", done: false },
  ],
};
        ...
        >
          ...
          <div style={{ marginTop: 14 }}>
            ...
            <div style={{ marginTop: 10, display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <span style={{ fontSize: 11, color: 'rgba(245,242,235,0.40)', flexShrink: 0 }}>
                {phase.progress}%
              </span>
            </div>
          ...
          <div style={{ borderTop: '1px solid rgba(245,242,235,0.07)', padding: '16px 22px 20px' }}>
                ...
                {['done', 'active', 'pending'].map(s => (
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: 100,
                      cursor: 'pointer',
                      border: phase.status === s
                        ? `1px solid ${B.yellow}`
                        : '1px solid rgba(245,242,235,0.12)',
                      background: phase.status === s
                        ? 'rgba(232,168,0,0.12)'
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {filteredTasks.length === 0 && (
                <div style={{ fontSize: 12, color: 'rgba(245,242,235,0.30)', padding: '8px 0' }}>
              ...
              {filteredTasks.map(task => {
                ...
                return (
                  <div key={task.id} style={{
                    ...
                    borderRadius: 12,
                    border: isDoneTask
                      ? '1px solid rgba(232,168,0,0.15)'
                      : '1px solid rgba(245,242,235,0.07)',
                    background: isDoneTask
                      ? 'rgba(232,168,0,0.06)'
                      : 'rgba(245,242,235,0.04)',
                    transition: 'all .2s',
                  }}>
                    <button
                      ...
                      style={{
                        ...
                        border: isDoneTask
                          ...
                          : '1.5px solid rgba(245,242,235,0.20)',
                        background: isDoneTask
                          ? 'rgba(232,168,0,0.18)'
                          : 'rgba(245,242,235,0.04)',
                        display: 'flex',
            ...
            <div key={m.id} style={{ display: 'flex', alignItems: 'flex-start', gap: 16 }}>
              <button
                ...
                style={{
                  ...
                  zIndex: 1,
                  border: m.done
                    ? `1px solid rgba(232,168,0,0.35)`
                    : past
                      ? '1px solid rgba(232,168,0,0.18)'
                      : '1px solid rgba(245,242,235,0.12)',
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <span style={{
                    ...
                    {formatDate(m.date)}
                    {!m.done && !past && days <= 7 && (
                      <span style={{ color: B.yellow }}> · {days}d</span>
                    )}
                  </span>
                </div>
              </div>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
      <div style={{
        ...
        <div>
          ...
          <div style={{ fontSize: 14, fontWeight: 700, color: B.cream, marginTop: 2 }}>
      ...
      {upcoming.map(s => {
        ...
        return (
          <div key={s.id} style={{
            ...
            <div>
              <div style={{ fontSize: 10, color: 'rgba(245,242,235,0.30)' }}>
                {s.label}
              </div>
              <div style={{ fontSize: 13, color: 'rgba(245,242,235,0.70)', marginTop: 2 }}>
                {s.title}
              </div>
            </div>
            ...
            <div style={{
              fontSize: 20,
              fontWeight: 800,
              color: d <= 2 ? '#ef4444' : d <= 5 ? B.ocker : 'rgba(245,242,235,0.45)',
...
/* ─── NOTIFICATION TOAST ─── */
const CLIENT_EMAIL = "pascalhagelgans@gmail.com";
...
Sobald du dir alles angeschaut hast, meld dich kurz mit deinem Feedback.
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ fontSize: 11, color: 'rgba(245,242,235,0.50)', marginTop: 2 }}>
              {phase.title}
            </div>
  ...
  const stats = [
    {
      ...
      sub: `${doneTasks}/${allTasks.length} Aufgaben`,
    },
    {
      label: 'Aktuelle Phase',
      value: activePhase?.label ?? '–',
      sub: activePhase?.title ?? 'Keine Phase aktiv',
    },
    {
      label: 'Geplante Übergabe',
    ...
    },
    {
      ...
      sub: 'Mehraufwand nur nach Absprache',
    },
  ];
      ...
      {stats.map((s, i) => (
        <Reveal key={s.label} delay={i * 60}>
          <div style={{
            ...
            <div style={{ fontSize: 11, color: 'rgba(245,242,235,0.38)', marginTop: 2 }}>
              {s.sub}
            </div>
          </div>
        </Reveal>
...
/* ─── PAGE ─── */
const STORAGE_KEY = "leon_project_pascal_angelo";
  ...
  const handleTaskToggle = useCallback((phaseId, taskId) => {
    setProject(prev => {
      ...
      return {
        ...prev,
        phases,
        overallProgress: recalcProgress(phases),
      };
    });
  }, [recalcProgress]);
    ...
    <div style={{
      ...
      <div style={{ position: 'fixed', inset: 0, zIndex: 0, pointerEvents: 'none' }}>
        <div style={{
          position: 'absolute',
          inset: 0,
          background: `radial-gradient(800px 600px at 20% 20%, rgba(232,168,0,0.07), transparent 60%)`,
        }} />
      ...
      <main style={{
        ...
        <Reveal>
          <div style={{ marginBottom: 18 }}>
            ...
            <p style={{
              ...
              Übersicht für Design, Figma-Umsetzung, Feedback und finale Übergabe.
              Der Projektpreis beträgt 250 €. Zusätzlicher Aufwand wird nur vorher transparent abgestimmt.
            </p>
          </div>
        </Reveal>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                    <div style={{
                      ...
                      <div>
                        ...
                        <div style={{ fontSize: 13, fontWeight: 800, color: B.cream, marginTop: 2 }}>
                          Landingpage Design & Development
                        </div>
                      </div>

                      <span style={{ fontSize: 22, fontWeight: 900, color: B.yellow }}>
                        {project.budget} €
                      </span>
                    </div>
                    ...
                    <div style={{
                      ...
                      <div style={{ fontSize: 10, color: 'rgba(245,242,235,0.30)', marginBottom: 4 }}>
                        Hinweis
                      </div>
                      ...
                      <div style={{
                        ...
                        Falls deutlich mehr Aufwand entsteht, wird das vorher transparent abgestimmt.
                        Zusätzliche Stunden werden mit 50 €/h berechnet.
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <Reveal delay={200}>
          <div style={{
            ...
            Leon Seitz · Projekt-Dashboard ·{' '}
            <a
              href="https://leonseitz.com"
              style={{
                color: 'rgba(245,242,235,0.35)',
