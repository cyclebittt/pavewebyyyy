...
import { Rocket, Workflow, Database, ArrowRight } from 'lucide-react';
...
export default function LeadPage() {
  ...
  const deliverables = [
    { icon: <Rocket className="text-indigo-300" />, t: 'Funnel‑Setup', d: 'Landing, Formulare, Follow‑Up, Automationen.' },
    { icon: <Workflow className="text-indigo-300" />, t: 'Nurturing', d: 'Sequenzen, Tags, Scoring, Kalender‑Connect.' },
    { icon: <Database className="text-indigo-300" />, t: 'CRM‑Integration', d: 'HubSpot/Pipedrive/Notion – sauber eingebunden.' },
  ];
    ...
    <div className="font-proxima bg-[#0B0B0F] text-white">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative px-5 md:px-16 pt-20 md:pt-28 pb-14">
          <h1 className="text-4xl md:text-6xl font-extrabold">Leads, die <span className="text-indigo-300">durchlaufen</span>.</h1>
          <p className="mt-4 max-w-2xl text-neutral-300">
            Von Klick zu Kunde: Funnel + CRM + Automationen – ohne Reibungsverlust.
          </p>
          <div className="mt-6">
      ...
      <ProofBlocks
        items={[
          { label: 'Lead‑zu‑Call‑Rate', value: '35–55 %', desc: 'durch klare Formulare + Nurturing.' },
          { label: 'Automatisierte Schritte', value: '12+', desc: 'Tags, Mails, Statuswechsel, Aufgaben.' },
          { label: 'Setup‑Zeit', value: '1–3 Wochen', desc: 'abhängig von CRM & Funnel‑Umfang.' },
        ]}
      />
