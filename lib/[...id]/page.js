        ...
        <div className="font-proxima">
            ...
            <div className="px-5 py-10">
                <div className="bg-neutral-100 rounded-3xl px-5 py-8 md:p-14 flex flex-col gap-10">
                    <h2 className='text-lg md:text-2xl font-medium'>Technology is constantly evolving, transforming industries and reshaping the way we live, work, and connect. As we look ahead, several key trends are emerging that promise to revolutionize the tech landscape. Here’s a glimpse into the future of technology and the innovations driving change.</h2>
